...
- Total Prize Pool: $4750 in USDC
  ...
  - Mitigation Review: $4000 in USDC (*Opportunity goes to top 3 certified wardens based on placement in this audit.*)
- Join [C4 Discord](https://discord.gg/code4rena) to register
- Submit findings [using the C4 form](https://code4rena.com/contests/2024-03-gitcoin-mitigation/submit)
...
The 4naly3er report can be found [here](https://github.com/code-423n4/2024-03-gitcoin-mitigation/blob/main/4naly3er-report.md).
